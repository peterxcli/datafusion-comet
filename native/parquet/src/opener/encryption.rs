...
impl EncryptionContext {
    ...
    pub(super) async fn get_file_decryption_properties(
        ...
        match &self.file_decryption_properties {
            Some(file_decryption_properties) => Ok(Some(Arc::clone(file_decryption_properties))),
...
impl EncryptionContext {
    ...
    ) -> Result<Option<std::sync::Arc<datafusion_common::encryption::FileDecryptionProperties>>>
    {
        Ok(None)
    }
}
